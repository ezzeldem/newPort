    ...
    t(
      ...
      function (t) {
        ...
        if (s) {
          ...
          if ("#header" == this.hash)
            return (
              a.classList.remove("header-top"),
              void l.forEach((e) => {
                e.classList.remove("section-show");
              })
            );
          a.classList.contains("header-top")
            ? (l.forEach((e) => {
                e.classList.remove("section-show");
              }),
              s.classList.add("section-show"))
            : (a.classList.add("header-top"),
              setTimeout(function () {
                l.forEach((e) => {
                  e.classList.remove("section-show");
                }),
      ...
      if (window.location.hash) {
        ...
        if (t) {
          ...
          s.classList.add("header-top"),
            o.forEach((e) => {
              e.getAttribute("href") == window.location.hash
